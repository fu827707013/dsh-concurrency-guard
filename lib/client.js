			...
			return h("div", { style: css.wrap },
				...
				tab === "errors" ? h("div", { style: css.section },
					...
					errTab === "kind" ? h("div", { style: css.section },
						h("h3", { style: css.sectionTitle }, `按 分类 × 错误信息 汇总（全历史累计 · 分类内按次数降序 · 最多 100 行）`),
						table(["分类", "次数", "错误信息", "最近出现"], errKindRows, "暂无异常记录（发生过的异常会按 分类×错误信息 聚合在此，含错误码/HTTP status/requestId）")
					) : null,
					...
					errTab === "detail" ? h("div", { style: css.section },
						h("h3", { style: css.sectionTitle }, `② 错误明细（每次错误一条 · 按会话+时间排序 · 最近 ${errEventCount} / 200 条滚动窗口）`),
